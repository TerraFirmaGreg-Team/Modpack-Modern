...
- Больше настроек рудных жил, настройка редкости индикаторов.
- Поверхностные вены в значительной степени менее распространены повсеместно; Более глубокие подземные жилы были затронуты в меньшей степени.
- Сера теперь появляется только рядом с лавой.
- Исправления
- Исправлены многие несоответствия между соленой и пресной водой из-за нового API кузнечной жидкости (#2542)
...
- Исправлена ошибка, из-за которой инструменты GT не выполняли специфичные для типа инструмента вещи, такие как создание контуров.
