...
- Отключена примитивная помпа из GTCEu, вы должны теперь использовать механическую из create (в работе).
...
- Отключен рецепт кавера на бесконечную воду, ха-ха (в работе).
...
- Исправлен срач в консоли из-за кривых ручонок разраба firmalife (в работе).
- Исправлен срач в консоли из-за кривых ручонок разраба create и рецептов прокатки create машины (в работе).
- Исправлен срач в консоли из-за кривых ручонок разраба firmaciv и carryon мода (в работе).
- Исправлен кривой рецепт для bloomery после обновления TFC до 3.2.0 версии (в работе).
