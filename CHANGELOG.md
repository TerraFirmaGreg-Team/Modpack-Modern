...
- Fixed Radiator Fan uncraftable recipe #1302
- Fixed Fluid Solidifier Recipe Conflict for Snow #1295
- Fixed Steel engine crafting by using the GT Rotor #1290
- Change Electrical Greenhouse to not consome the input but lower the seed output
- Fixed the Autoclave recipe to make Rose Quartz at MV
