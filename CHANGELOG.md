...
- Для чистого железа добавлен металл железа, теперь вы можете быстро делать себе кучи слитков железа, возрадуйтесь.
- Начало интеграции Create.
- Теперь каменные плиты тоже осыпаются, хи-хи.

## [0.3.0] - Ожидается 25.12.2023
### Изменения
