...
//#region Assign Tags
  const materials = [
    //tags
    '#tfc:rock/bricks', '#tfc:rock/smooth', '#tfc:rock/gravel', '#minecraft:planks', '#minecraft:logs', '#tfc:colored_raw_alabaster', '#tfc:colored_bricks_alabaster', '#tfc:colored_polished_alabaster', '#tfc:mud_bricks', '#forge:sandstone',
    //rnr shingles
