...
function registerTFGCoalRecipes(event) {
	...
	event.recipes.gtceu.pyrolyse_oven("tfg:coal_to_coal_gas")
		.itemInputs('8x tfc:ore/bituminous_coal')
		.itemOutputs('16x gtceu:coke_gem')
		.inputFluids(Fluid.of('gtceu:steam', 4000))
	...
	event.remove({ id: 'gtceu:pyrolyse_oven/coal_block_to_coke_creosote' })
	event.remove({ id: 'gtceu:pyrolyse_oven/coal_block_to_coal_gas' })
	event.remove({ id: 'gtceu:pyrolyse_oven/coal_block_to_coke_creosote_nitrogen' })
	
	event.recipes.gtceu.pyrolyse_oven("tfg:block_coal_to_coke_creosote")
		.itemInputs('4x minecraft:coal_block')
		.itemOutputs('8x gtceu:coke_block')
		.outputFluids(Fluid.of('gtceu:creosote', 8000 * 4.5))
		.duration(576 * 4.5)
		.EUt(64)
		.circuit(1)

	event.recipes.gtceu.pyrolyse_oven("tfg:block_coal_to_coal_gas")
		.itemInputs('4x minecraft:coal_block')
		.itemOutputs('8x gtceu:coke_block')
		.inputFluids(Fluid.of('gtceu:steam', 4000 * 4.5))
		.outputFluids(Fluid.of('gtceu:coal_gas', 4000 * 4.5))
		.duration(288 * 4.5)
		.EUt(96)
		.circuit(22)

	event.recipes.gtceu.pyrolyse_oven("tfg:block_coal_to_coke_creosote_nitrogen")
		.itemInputs('4x minecraft:coal_block')
		.itemOutputs('8x gtceu:coke_block')
		.inputFluids(Fluid.of('gtceu:nitrogen', 1000 * 4.5))
		.outputFluids(Fluid.of('gtceu:creosote', 8000 * 4.5))
		.duration(288 * 4.5)
		.EUt(96)
		.circuit(2)
