...
function registerTFGNuclearRecipes(event) {
	...
	event.recipes.gtceu.nuclear_fuel_factory('tfg:americium_pellet')
		.itemInputs('32x #forge:rods/americium_241', 'tfg:empty_rod')
		.inputFluids(Fluid.of('gtceu:radon', 100))
	...
	event.recipes.gtceu.nuclear_fuel_factory('tfg:neptunium_pellet')
		.itemInputs('32x #forge:rods/neptunium_237', '32x #forge:rods/neptunium_237', 'tfg:empty_rod')
		.inputFluids(Fluid.of('gtceu:radon', 100))
	...
	event.recipes.gtceu.nuclear_fuel_factory('tfg:tbu_232_rod_recycle')
		...
		.itemInputs('32x gtceu:thorium_230_dust', '32x #forge:rods/thorium_232', '32x #forge:rods/thorium_232', '32x #forge:rods/thorium_232', 'tfg:empty_rod')
...
/*
    ...
    event.recipes.gtceu.nuclear_fuel_factory('tfg:californium_t1')
        ...
        .duration(20*3)
        .EUt(GTValues.VA[GTValues.IV])
		.addDataString("avgHeat1", "600")
		.addDataString("avgHeat2", "699")
		.dimension('ad_astra:mars')
