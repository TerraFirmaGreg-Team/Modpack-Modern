...
function registerTFGBiodieselRecipes(event) {
	...
	event.recipes.gtceu.chemical_reactor(`tfg:seed_oil_alcohol_biodiesel`)
	...
	event.recipes.gtceu.chemical_reactor(`tfg:peanut_oil_alcohol_biodiesel`)
	...
	event.recipes.gtceu.chemical_reactor(`tfg:palm_oil_alcohol_biodiesel`)
		.inputFluids("#tfg:alcohols 1000", Fluid.of('tfg:palm_oil', 6000))
		.itemInputs('#forge:tiny_dusts/sodium_hydroxide')
		.outputFluids(Fluid.of('gtceu:bio_diesel', 6000))
		.duration(20 * 10)
		.EUt(GTValues.VHA[GTValues.ULV])
	...
	event.recipes.gtceu.mixer(`tfg:peanut_oil_alcohol_biodiesel`)
		...
		.duration(20 * 10)
		.EUt(GTValues.VHA[GTValues.ULV])
	event.recipes.gtceu.mixer(`tfg:palm_oil_alcohol_biodiesel`)
		.inputFluids("#tfg:alcohols 1000", Fluid.of('tfg:palm_oil', 1000))
		.itemInputs('#forge:tiny_dusts/sodium_hydroxide')
		.outputFluids(Fluid.of('gtceu:bio_diesel', 500))
		.duration(20 * 10)
		.EUt(GTValues.VHA[GTValues.ULV])

	event.recipes.gtceu.chemical_reactor(`tfg:olive_oil_alcohol_biodiesel`)
	...
	event.recipes.gtceu.chemical_reactor(`tfg:soybean_oil_alcohol_biodiesel`)
	...
	event.recipes.gtceu.chemical_reactor(`tfg:fish_oil_alcohol_biodiesel`)
	...
	event.recipes.gtceu.chemical_reactor(`tfg:tallow_alcohol_biodiesel`)
	...
	event.recipes.gtceu.chemical_reactor(`tfg:olive_oil_ethanol_biodiesel`)
	...
	event.recipes.gtceu.chemical_reactor(`tfg:olive_oil_methanol_biodiesel`)
	...
	event.recipes.gtceu.chemical_reactor(`tfg:soybean_oil_ethanol_biodiesel`)
	...
	event.recipes.gtceu.chemical_reactor(`tfg:tallow_methanol_biodiesel`)
		.inputFluids(Fluid.of('tfc:tallow', 4000), Fluid.of('gtceu:methanol', 1000))
		.itemInputs('#forge:tiny_dusts/sodium_hydroxide')
		.outputFluids(Fluid.of('gtceu:glycerol'), Fluid.of('gtceu:bio_diesel', 6000))
		.duration(20 * 10)
		.EUt(GTValues.VHA[GTValues.LV])

	event.recipes.gtceu.chemical_reactor(`tfg:tallow_ethanol_biodiesel`)
		.inputFluids(Fluid.of('tfc:tallow', 4000), Fluid.of('gtceu:ethanol', 1000))
		.itemInputs('#forge:tiny_dusts/sodium_hydroxide')
		.outputFluids(Fluid.of('gtceu:glycerol'), Fluid.of('gtceu:bio_diesel', 6000))
		.duration(20 * 10)
		.EUt(GTValues.VHA[GTValues.LV])

	event.recipes.gtceu.chemical_reactor(`tfg:peanut_oil_ethanol_biodiesel`)
		.inputFluids(Fluid.of('tfg:peanut_oil', 4000), Fluid.of('gtceu:ethanol', 1000))
		.itemInputs('#forge:tiny_dusts/sodium_hydroxide')
		.outputFluids(Fluid.of('gtceu:glycerol'), Fluid.of('gtceu:bio_diesel', 6000))
		.duration(20 * 10)
		.EUt(GTValues.VHA[GTValues.LV])

	event.recipes.gtceu.chemical_reactor(`tfg:peanut_oil_methanol_biodiesel`)
		.inputFluids(Fluid.of('tfg:peanut_oil', 4000), Fluid.of('gtceu:methanol', 1000))
		.itemInputs('#forge:tiny_dusts/sodium_hydroxide')
		.outputFluids(Fluid.of('gtceu:glycerol'), Fluid.of('gtceu:bio_diesel', 6000))
		.duration(20 * 10)
		.EUt(GTValues.VHA[GTValues.LV])

	event.recipes.gtceu.chemical_reactor(`tfg:palm_oil_ethanol_biodiesel`)
		.inputFluids(Fluid.of('tfg:palm_oil', 4000), Fluid.of('gtceu:ethanol', 1000))
		.itemInputs('#forge:tiny_dusts/sodium_hydroxide')
		.outputFluids(Fluid.of('gtceu:glycerol'), Fluid.of('gtceu:bio_diesel', 6000))
		.duration(20 * 10)
		.EUt(GTValues.VHA[GTValues.LV])

	event.recipes.gtceu.chemical_reactor(`tfg:palm_oil_methanol_biodiesel`)
		.inputFluids(Fluid.of('tfg:palm_oil', 4000), Fluid.of('gtceu:methanol', 1000))
		.itemInputs('#forge:tiny_dusts/sodium_hydroxide')
		.outputFluids(Fluid.of('gtceu:glycerol'), Fluid.of('gtceu:bio_diesel', 6000))
		.duration(20 * 10)
		.EUt(GTValues.VHA[GTValues.LV])
