...
function registerTFGBiodieselRecipes(event) {
	...
	event.recipes.gtceu.chemical_reactor(`palm_oil_alcohol_biodiesel`)
	...
	event.recipes.gtceu.chemical_reactor(`peanut_oil_ethanol_biodiesel`)
	...
	event.recipes.gtceu.chemical_reactor(`peanut_oil_methanol_biodiesel`)
	...
	event.recipes.gtceu.chemical_reactor(`palm_oil_ethanol_biodiesel`)
	...
	event.recipes.gtceu.chemical_reactor(`palm_oil_methanol_biodiesel`)
