...
const registerTFGRecipes = (event) =>
{
  ...
  event.recipes.gtceu.assembler(`tfg:copper_coil_block`)             
  ...
  event.recipes.createSequencedAssembly([
    ...
    event.recipes.createDeploying('tfg:unfinished_copper_coil_block', ['tfg:unfinished_copper_coil_block', 'gtceu:copper_double_wire']),
    event.recipes.createDeploying('tfg:unfinished_copper_coil_block', ['tfg:unfinished_copper_coil_block', '#forge:foils/copper']),
