...
function registerTFGCoilRecipes(event) {
	...
	event.recipes.gtceu.implosion_compressor('tfg:chorus_ceramic_insulation_dynamite')
		.itemInputs('ae2:sky_dust', '#forge:dusts/perlite', '#forge:dusts/kaolinite', '#forge:dusts/granulated_chorus', 'ae2:fluix_dust', '2x gtceu:dynamite')
	...
	event.recipes.gtceu.implosion_compressor('tfg:chorus_ceramic_insulation_powderbarrel')
		.itemInputs('ae2:sky_dust', '#forge:dusts/perlite', '#forge:dusts/kaolinite', '#forge:dusts/granulated_chorus', 'ae2:fluix_dust', '8x gtceu:powderbarrel')
		.itemOutputs('tfg:chorus_ceramic_insulation')
		.chancedOutput('#forge:dusts/dark_ash', 2500, 0)
		.duration(20)
		.EUt(GTValues.VA[GTValues.LV])
	...
	event.recipes.gtceu.implosion_compressor('tfg:chorus_ceramic_insulation_tnt')
		.itemInputs('ae2:sky_dust', '#forge:dusts/perlite', '#forge:dusts/kaolinite', '#forge:dusts/granulated_chorus', 'ae2:fluix_dust', '4x minecraft:tnt')
		.itemOutputs('tfg:chorus_ceramic_insulation')
		.chancedOutput('#forge:dusts/dark_ash', 2500, 0)
		.duration(20)
		.EUt(GTValues.VA[GTValues.LV])
	...
	event.recipes.gtceu.implosion_compressor('tfg:chorus_ceramic_insulation_itnt')
		.itemInputs('ae2:sky_dust', '#forge:dusts/perlite', '#forge:dusts/kaolinite', '#forge:dusts/granulated_chorus', 'ae2:fluix_dust', 'gtceu:industrial_tnt')
		.itemOutputs('tfg:chorus_ceramic_insulation')
		.chancedOutput('#forge:dusts/dark_ash', 2500, 0)
		.duration(20)
		.EUt(GTValues.VA[GTValues.LV])
