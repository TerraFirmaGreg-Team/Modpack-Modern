...
/*	event.recipes.gtceu.electric_blast_furnace('ammonium_chloryde')
	...
	event.recipes.gtceu.heat_exchanger('flibe_cooling')
		...
		.chancedFluidInput(Fluid.of('gtceu:hastelloy_c_276', 100), 100, 0)
	...
	event.recipes.gtceu.fission_reactor('uranium_radioactive')
		...
		.inputFluids(Fluid.of('gtceu:heavy_water', 200))
		.outputFluids(Fluid.of('gtceu:radioactive_steam', 200))
	...
	event.recipes.gtceu.fission_reactor('plutonium_irradiated')
		...
		.inputFluids(Fluid.of('gtceu:heavy_water', 200))
		.outputFluids(Fluid.of('gtceu:irradiated_steam', 200))
	...
	event.recipes.gtceu.fission_reactor('tbu_reactor')
		...
		.inputFluids(Fluid.of('gtceu:flibe', 200))
		.outputFluids(Fluid.of('gtceu:hot_flibe', 200))
