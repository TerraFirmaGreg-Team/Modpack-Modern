...
function registerTFGWoodenRecipes(event) {
    ...
    // #region Beneath
    const BeneathWood = ["crimson", "warped"]

    BeneathWood.forEach(wood => {
    ...
    // TODO: Condense all the recycling index into one array
    // Beneath recipes are parked here so I can edit easier
    // Recycling
    /**
