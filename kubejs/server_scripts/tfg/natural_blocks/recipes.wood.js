...
function registerTFGWoodenRecipes(event) {
    ...
    function registerRopeLadderRecipe(name, plank) {
    ...
    const TFG_ROPE_LADDER_WOODS = [
        { name: 'araucaria', plank: 'tfg:wood/planks/araucaria' },
        { name: 'beech', plank: 'tfg:wood/planks/beech' },
        { name: 'mahoe', plank: 'tfg:wood/planks/mahoe' },
        { name: 'ginkgo', plank: 'wan_ancient_beasts:ginkgo_planks' }
    ];
    ...
    // #region TFG Native / External Wood Rope Ladders

        TFG_ROPE_LADDER_WOODS.forEach(wood => {
            registerRopeLadderRecipe(wood.name, wood.plank);
        });
    ...
    // #region Beneath
        ...
        global.BENEATH_WOOD_TYPES.forEach(wood => {
            ...
            registerRopeLadderRecipe(wood, `beneath:wood/planks/${wood}`);
        });
    ...
    // #region AFC
        ...
        global.AFC_WOOD_TYPES.forEach(wood => {
            ...
            registerRopeLadderRecipe(wood, `afc:wood/planks/${wood}`);
    ...
    // #region TFC
        ...
        global.TFC_WOOD_TYPES.forEach(wood => {
            ...
            registerRopeLadderRecipe(wood, `tfc:wood/planks/${wood}`);
        });
