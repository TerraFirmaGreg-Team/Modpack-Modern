...
function registerTFGRailgunItemTags(event) {
	...
	event.add('tfg:cannot_launch_in_railgun', 'ae2:portable_item_cell_1k')
	event.add('tfg:cannot_launch_in_railgun', 'ae2:portable_item_cell_4k')
	event.add('tfg:cannot_launch_in_railgun', 'ae2:portable_item_cell_16k')
	event.add('tfg:cannot_launch_in_railgun', 'ae2:portable_item_cell_64k')
	event.add('tfg:cannot_launch_in_railgun', 'ae2:portable_item_cell_256k')
	...
	event.add('tfg:cannot_launch_in_railgun', 'ae2:portable_fluid_cell_1k')
	event.add('tfg:cannot_launch_in_railgun', 'ae2:portable_fluid_cell_4k')
	event.add('tfg:cannot_launch_in_railgun', 'ae2:portable_fluid_cell_16k')
	event.add('tfg:cannot_launch_in_railgun', 'ae2:portable_fluid_cell_64k')
	event.add('tfg:cannot_launch_in_railgun', 'ae2:portable_fluid_cell_256k')
	...
	event.add('tfg:cannot_launch_in_railgun', 'megacells:portable_item_cell_1m')
	event.add('tfg:cannot_launch_in_railgun', 'megacells:portable_item_cell_4m')
	event.add('tfg:cannot_launch_in_railgun', 'megacells:portable_item_cell_16m')
	event.add('tfg:cannot_launch_in_railgun', 'megacells:portable_item_cell_64m')
	...
	event.add('tfg:cannot_launch_in_railgun', 'megacells:portable_fluid_cell_1m')
	event.add('tfg:cannot_launch_in_railgun', 'megacells:portable_fluid_cell_4m')
	...
	event.add('tfg:cannot_launch_in_railgun', 'gtceu:gold_drum')
	event.add('tfg:cannot_launch_in_railgun', 'gtceu:bronze_drum')
	event.add('tfg:cannot_launch_in_railgun', 'gtceu:black_bronze_drum')
	event.add('tfg:cannot_launch_in_railgun', 'gtceu:bismuth_bronze_drum')
	event.add('tfg:cannot_launch_in_railgun', 'gtceu:steel_drum')
	event.add('tfg:cannot_launch_in_railgun', 'gtceu:aluminium_drum')
