...
function registerTFGSpaceRecipes(event) {
	...
	event.recipes.gtceu.assembler('tfg:ulv_input_to_ulv_railgun_input_assembler')
		.itemInputs('gtceu:ulv_input_bus')
		.circuit(4)
		.itemOutputs('tfg:ulv_railgun_item_loader_in')
		.duration(20 * 5)
		.EUt(GTValues.VA[GTValues.LV])

	event.recipes.gtceu.assembler('tfg:lv_input_to_lv_railgun_input_assembler')
		.itemInputs('gtceu:lv_input_bus')
		.circuit(4)
		.itemOutputs('tfg:lv_railgun_item_loader_in')
		.duration(20 * 5)
		.EUt(GTValues.VA[GTValues.LV])

	event.recipes.gtceu.assembler('tfg:mv_input_to_mv_railgun_input_assembler')
		.itemInputs('gtceu:mv_input_bus')
		.circuit(4)
		.itemOutputs('tfg:mv_railgun_item_loader_in')
		.duration(20 * 5)
		.EUt(GTValues.VA[GTValues.LV])

	event.recipes.gtceu.assembler('tfg:hv_input_to_hv_railgun_input_assembler')
		.itemInputs('gtceu:hv_input_bus')
		.circuit(4)
		.itemOutputs('tfg:hv_railgun_item_loader_in')
		.duration(20 * 5)
		.EUt(GTValues.VA[GTValues.LV])

	event.recipes.gtceu.assembler('tfg:ev_input_to_ev_railgun_input_assembler')
		.itemInputs('gtceu:ev_input_bus')
		.circuit(4)
		.itemOutputs('tfg:ev_railgun_item_loader_in')
		.duration(20 * 5)
		.EUt(GTValues.VA[GTValues.LV])

	event.recipes.gtceu.assembler('tfg:iv_input_to_iv_railgun_input_assembler')
		.itemInputs('gtceu:iv_input_bus')
		.circuit(4)
		.itemOutputs('tfg:iv_railgun_item_loader_in')
		.duration(20 * 5)
		.EUt(GTValues.VA[GTValues.LV])

	event.recipes.gtceu.assembler('tfg:luv_input_to_luv_railgun_input_assembler')
		.itemInputs('gtceu:luv_input_bus')
		.circuit(4)
		.itemOutputs('tfg:luv_railgun_item_loader_in')
		.duration(20 * 5)
		.EUt(GTValues.VA[GTValues.LV])

	event.recipes.gtceu.assembler('tfg:zpm_input_to_zpm_railgun_input_assembler')
		.itemInputs('gtceu:zpm_input_bus')
		.circuit(4)
		.itemOutputs('tfg:zpm_railgun_item_loader_in')
		.duration(20 * 5)
		.EUt(GTValues.VA[GTValues.LV])

	event.recipes.gtceu.assembler('tfg:uv_input_to_uv_railgun_input_assembler')
		.itemInputs('gtceu:uv_input_bus')
		.circuit(4)
		.itemOutputs('tfg:uv_railgun_item_loader_in')
		.duration(20 * 5)
		.EUt(GTValues.VA[GTValues.LV])

	event.recipes.gtceu.assembler('tfg:uhv_input_to_uhv_railgun_input_assembler')
		.itemInputs('gtceu:uhv_input_bus')
		.circuit(4)
		.itemOutputs('tfg:uhv_railgun_item_loader_in')
		.duration(20 * 5)
		.EUt(GTValues.VA[GTValues.LV])

	event.recipes.gtceu.assembler('tfg:ulv_output_to_ulv_railgun_output_assembler')
		.itemInputs('gtceu:ulv_output_bus')
		.circuit(4)
		.itemOutputs('tfg:ulv_railgun_item_loader_out')
		.duration(20 * 5)
		.EUt(GTValues.VA[GTValues.LV])

	event.recipes.gtceu.assembler('tfg:lv_output_to_lv_railgun_output_assembler')
		.itemInputs('gtceu:lv_output_bus')
		.circuit(4)
		.itemOutputs('tfg:lv_railgun_item_loader_out')
		.duration(20 * 5)
		.EUt(GTValues.VA[GTValues.LV])

	event.recipes.gtceu.assembler('tfg:mv_output_to_mv_railgun_output_assembler')
		.itemInputs('gtceu:mv_output_bus')
		.circuit(4)
		.itemOutputs('tfg:mv_railgun_item_loader_out')
		.duration(20 * 5)
		.EUt(GTValues.VA[GTValues.LV])

	event.recipes.gtceu.assembler('tfg:hv_output_to_hv_railgun_output_assembler')
		.itemInputs('gtceu:hv_output_bus')
		.circuit(4)
		.itemOutputs('tfg:hv_railgun_item_loader_out')
		.duration(20 * 5)
		.EUt(GTValues.VA[GTValues.LV])

	event.recipes.gtceu.assembler('tfg:ev_output_to_ev_railgun_output_assembler')
		.itemInputs('gtceu:ev_output_bus')
		.circuit(4)
		.itemOutputs('tfg:ev_railgun_item_loader_out')
		.duration(20 * 5)
		.EUt(GTValues.VA[GTValues.LV])

	event.recipes.gtceu.assembler('tfg:iv_output_to_iv_railgun_output_assembler')
		.itemInputs('gtceu:iv_output_bus')
		.circuit(4)
		.itemOutputs('tfg:iv_railgun_item_loader_out')
		.duration(20 * 5)
		.EUt(GTValues.VA[GTValues.LV])

	event.recipes.gtceu.assembler('tfg:luv_output_to_luv_railgun_output_assembler')
		.itemInputs('gtceu:luv_output_bus')
		.circuit(4)
		.itemOutputs('tfg:luv_railgun_item_loader_out')
		.duration(20 * 5)
		.EUt(GTValues.VA[GTValues.LV])

	event.recipes.gtceu.assembler('tfg:zpm_output_to_zpm_railgun_output_assembler')
		.itemInputs('gtceu:zpm_output_bus')
		.circuit(4)
		.itemOutputs('tfg:zpm_railgun_item_loader_out')
		.duration(20 * 5)
		.EUt(GTValues.VA[GTValues.LV])

	event.recipes.gtceu.assembler('tfg:uv_output_to_uv_railgun_output_assembler')
		.itemInputs('gtceu:uv_output_bus')
		.circuit(4)
		.itemOutputs('tfg:uv_railgun_item_loader_out')
		.duration(20 * 5)
		.EUt(GTValues.VA[GTValues.LV])

	event.recipes.gtceu.assembler('tfg:uhv_output_to_uhv_railgun_output_assembler')
		.itemInputs('gtceu:uhv_output_bus')
		.circuit(4)
		.itemOutputs('tfg:uhv_railgun_item_loader_out')
		.duration(20 * 5)
		.EUt(GTValues.VA[GTValues.LV])
