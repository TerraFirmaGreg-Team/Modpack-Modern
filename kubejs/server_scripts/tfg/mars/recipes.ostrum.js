...
*/
	...
	//#region Dense Ostrum Vapor
		...
		event.recipes.gtceu.ostrum_linear_accelerator('tfg:naquadah')
			.perTick(true)
			.inputFluids(Fluid.of('gtceu:residual_radioactive_concoction', 1))
			.perTick(false)
			.itemInputs(Item.of('tfg:alumina_dust', 10))
			.inputFluids(Fluid.of('gtceu:dense_ostrum_vapor', 1000), Fluid.of('tfg:radioactive_effluent', 100))
			.itemOutputsRanged('#forge:poor_raw_materials/naquadah', 10, 50)
			.itemOutputsRanged('#forge:raw_materials/naquadah', 10, 30)
			.itemOutputsRanged('#forge:rich_raw_materials/naquadah', 5, 15)
