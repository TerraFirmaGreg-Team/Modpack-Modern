...
*/
	...
	//#region Dense Ostrum Vapor
		...
		event.recipes.gtceu.ostrum_linear_accelerator('tfg:naquadah')
			...
			.itemOutputsRanged('#forge:poor_raw_materials/naquadah', 1, 10)
			.itemOutputsRanged('#forge:raw_materials/naquadah', 1, 10)
			.itemOutputsRanged('#forge:rich_raw_materials/naquadah', 1, 10)
