...
function registerTFGOverworldBiomeTags(event) {
	...
	event.add('tfg:never_has_structure/malay_illage', 'tfg:earth/ocean')
	event.add('tfg:never_has_structure/malay_illage', 'tfg:earth/ocean_reef')
	event.add('tfg:never_has_structure/malay_illage', 'tfg:earth/deep_ocean')
	event.add('tfg:never_has_structure/malay_illage', 'tfg:earth/deep_ocean_trench')
	event.add('tfg:never_has_structure/malay_illage', 'tfg:earth/sea_stacks')
	event.add('tfg:never_has_structure/malay_illage', 'tfg:earth/terrace_upper')
	event.add('tfg:never_has_structure/malay_illage', 'tfg:earth/terrace_lower')
	event.add('tfg:never_has_structure/malay_illage', 'tfg:earth/rocky_shores')
	event.add('tfg:never_has_structure/malay_illage', 'tfg:earth/embayments')
	event.add('tfg:never_has_structure/malay_illage', 'tfg:earth/guano_island')
	event.add('tfg:never_has_structure/malay_illage', 'tfg:earth/ice_sheet_oceanic')
	event.add('tfg:never_has_structure/malay_illage', 'tfg:earth/ice_sheet_shore')
