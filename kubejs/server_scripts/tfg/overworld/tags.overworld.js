...
function registerTFGOverworldBiomeTags(event) {
	...
	event.add('tfg:has_structure/plains_temperate_0', 'tfg:earth/river_valley')
	event.add('tfg:has_structure/plains_temperate_0', 'tfg:earth/rift_valley')
	...
	event.add('tfg:has_structure/aqueduct', 'tfg:earth/rift_lake')
	event.add('tfg:has_structure/aqueduct', 'tfg:earth/rift_valley')
	event.add('tfg:has_structure/aqueduct', 'tfg:earth/river_valley')
	...
	event.add('tfg:has_structure/ocean_moai_0', 'tfg:earth/volcanic_mountain_islands')
	event.add('tfg:has_structure/ocean_moai_0', 'tfg:earth/volcanic_island')
	...
	event.add('tfg:has_structure/illages', 'tfg:earth/river_valley')
	...
	event.add('tfg:has_structure/illager_camp', 'tfg:earth/rift_valley')
	event.add('tfg:has_structure/illager_camp', 'tfg:earth/river_valley')
	...
	event.add('tfc_ruins:has_structure/ruin_beach', 'tfg:earth/ocean_atolls')
	event.add('tfc_ruins:has_structure/ruin_beach', 'tfg:earth/deep_ocean_atolls')
	...
	event.add('tfc_ruins:has_structure/ruin_small', 'tfg:earth/rift_valley')
	event.add('tfc_ruins:has_structure/ruin_small', 'tfg:earth/river_valley')
	...
	event.add('tfc_ruined_world:has_structure/large_structure', 'tfg:earth/river_valley')
...
function registerTFGOverworldPlacedFeatures(event) {
	...
	event.add('tfg:in_biome/surface_decoration/glaciated_oceanic_mountains', 'tfg:earth/rose_quartz/rose_quartz')
	event.add('tfg:in_biome/surface_decoration/glaciated_shield_volcano', 'tfg:earth/rose_quartz/rose_quartz')
	event.add('tfg:in_biome/surface_decoration/ice_sheet_volcanic_mountains', 'tfg:earth/rose_quartz/rose_quartz')
	...
	// Volcanoes
	event.add("tfg:feature/cinder_cones", "tfg:earth/volcano/random_cinder_cone");
	...
	event.add("tfg:feature/stratovolcanoes", "tfg:earth/volcano/stratovolcano_ash_pile");
	event.add("tfg:feature/stratovolcanoes", "tfg:earth/volcano/stratovolcano_sulfur_patch");
	event.add("tfg:feature/stratovolcanoes", "tfg:earth/volcano/stratovolcano_fuji_smoke");
	event.add("tfg:feature/stratovolcanoes", "tfg:earth/volcano/stratovolcano_fuji_spout");
	event.add("tfg:feature/stratovolcanoes", "tfg:earth/volcano/stratovolcano_kelimutu_smoke");
	event.add("tfg:feature/stratovolcanoes", "tfg:earth/volcano/stratovolcano_kelimutu_spout");
	event.add("tfg:feature/stratovolcanoes", "tfg:earth/volcano/stratovolcano_tahoma_smoke");
	event.add("tfg:feature/stratovolcanoes", "tfg:earth/volcano/stratovolcano_tahoma_spout");
	...
	const palmFruitBiomes = [
		...
		'tfg:in_biome/large_features/oceanic_volcanic_arc',
		'tfg:in_biome/large_features/volcanic_mountain_islands',
		'tfg:in_biome/large_features/volcanic_island'
	];
	...
	// Higher chance on atolls
	const commonPalmFruitBiomes = [
		"tfg:in_biome/large_features/sunken_shield_volcano",
		'tfg:in_biome/large_features/ocean_atolls',
		'tfg:in_biome/large_features/deep_ocean_atolls',
	];	
	commonPalmFruitBiomes.forEach(biome => {
		event.add(biome, 'tfg:earth/crop/palm_tree/coconut_patch_common');
		event.add(biome, 'tfg:earth/crop/palm_tree/date_patch_common');
	});
}
