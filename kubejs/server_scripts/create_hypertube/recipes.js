...
function registerCreateHypertubeRecipes(event) {
	...
	event.recipes.gtceu.assembler('create_hypertube:hypertube')
		...
		.itemOutputs('16x create_hypertube:hypertube')
		.circuit(1)
	...
	event.recipes.gtceu.assembler('create_hypertube:entrance')
		...
		.itemOutputs('2x create_hypertube:hypertube_entrance')
	...
	event.recipes.gtceu.assembler('create_hypertube:accelerator')
		...
		.itemOutputs('2x create_hypertube:hypertube_accelerator')
		.inputFluids(Fluid.of('gtceu:silicone_rubber', 288))
		.EUt(GTValues.VA[GTValues.HV])
		.duration(100)
		.addMaterialInfo(true)
	...
	event.recipes.gtceu.assembler('create_hypertube:funnel')
		.itemInputs('4x #forge:plates/stainless_steel', 'create:brass_funnel', 'greate:stainless_steel_cogwheel', 'ae2:charged_certus_quartz_crystal')
		.itemOutputs('2x create_hypertube:hypertube_funnel')
		.inputFluids(Fluid.of('gtceu:silicone_rubber', 288))
		.EUt(GTValues.VA[GTValues.HV])
		.duration(100)
		.addMaterialInfo(true)

	event.recipes.gtceu.assembler('create_hypertube:funnel_sbr')
		.itemInputs('4x #forge:plates/stainless_steel', 'create:brass_funnel', 'greate:stainless_steel_cogwheel', 'ae2:charged_certus_quartz_crystal')
		.itemOutputs('2x create_hypertube:hypertube_funnel')
		.inputFluids(Fluid.of('gtceu:styrene_butadiene_rubber', 144))
		.EUt(GTValues.VA[GTValues.HV])
	...
	event.recipes.gtceu.assembler('create_hypertube:junction')
		.itemInputs('4x #forge:plates/stainless_steel', 'create:brass_tunnel', 'greate:stainless_steel_cogwheel', 'ae2:charged_certus_quartz_crystal')
		.itemOutputs('2x create_hypertube:hypertube_junction')
		.inputFluids(Fluid.of('gtceu:silicone_rubber', 288))
		.EUt(GTValues.VA[GTValues.HV])
		.duration(100)
		.addMaterialInfo(true)

	event.recipes.gtceu.assembler('create_hypertube:junction_sbr')
		.itemInputs('4x #forge:plates/stainless_steel', 'create:brass_tunnel', 'greate:stainless_steel_cogwheel', 'ae2:charged_certus_quartz_crystal')
		.itemOutputs('2x create_hypertube:hypertube_junction')
		.inputFluids(Fluid.of('gtceu:styrene_butadiene_rubber', 144))
		.EUt(GTValues.VA[GTValues.HV])
