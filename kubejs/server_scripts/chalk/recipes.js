...
const registerChalkRecipes = (evt) =>
{
        ...
        global.MINECRAFT_DYE_NAMES.forEach(dyeName =>
            {
                ...
                evt.recipes.gtceu.mixer(`chalk:gt_mixer/${dyeName}_chalk_from_${sizeComputed}dust`)
                    .itemInputs(["minecraft:clay_ball", `${count[i]}x #chalk:${sizeComputed}dusts_for_chalks`])
                    .inputFluids([Fluid.of(`tfc:${dyeName}_dye`, 125)])
                    .itemOutputs([`chalk:${dyeName}_chalk`])
                    .duration(600)
                    .EUt(1);
    
                //create mixer creates the unfired colored stick, unless heated.
                let createIngredients = ["minecraft:clay_ball", `${count[i]}x #chalk:${sizeComputed}dusts_for_chalks`, Fluid.of(`tfc:${dyeName}_dye`,  250)]
    ...
    global.MINECRAFT_DYE_NAMES.forEach(dyeName =>
    {
        evt.recipes.tfc.barrel_sealed(20 * 50)
            .inputs(`tfg:unfired_chalk`, TFC.fluidStackIngredient(`tfc:${dyeName}_dye`, 500))
