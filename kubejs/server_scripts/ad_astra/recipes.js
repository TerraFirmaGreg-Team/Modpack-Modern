...
*/
	...
	event.recipes.gtceu.shaped('ad_astra:zip_gun', [
		'ACC',
		'DB ',
		'   '
	], {
		...
		D: 'ad_astra:gas_tank',
	}).addMaterialInfo().id('tfg:zip_gun')

	//#endregion

	//#region Космо картина

	event.recipes.gtceu.shaped('ad_astra:space_painting', [
		'AAA',
		'ACA',
		'AAA'
	], {
	...
	}).addMaterialInfo().id('tfg:space_painting')
