...
const ItemHeats = {
    ...
    "chain": { heat_capacity: 0.171, metal_amount: 9, rules: [ "hit_any", "hit_any", "draw_last" ], anvilFrom: "ingot",
        input: (name) => { return { item: `tfc:metal/chain/${name}` } }, 
        output: (name) => { return { item: `tfc:metal/chain/${name}` } } },
    "bars": { heat_capacity: 0.714, metal_amount: 36, rules: [ "upset_last", "punch_second_last", "punch_third_last" ], anvilFrom: "sheet",
    ...
    "rod": { heat_capacity: 1.429, metal_amount: 72, rules: [ "bend_last", "draw_second_last", "draw_third_last" ], anvilFrom: "ingot",
