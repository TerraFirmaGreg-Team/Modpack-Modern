...
const registerRailWaysRecipes = (event) => {
    ...
    //#region Locometal
    // Slashed Locometal
    event.recipes.gtceu.assembler(`tfg:railways/slashed_locometal`)
        .itemInputs(`#forge:storage_blocks/steel`)
        .circuit(1)
        .itemOutputs(`8x railways:slashed_locometal`)
        .duration(200)
        .EUt(28)

    // Brass Wrapped Locometal
    event.recipes.gtceu.assembler(`tfg:railways/brass_wrapped_locometal`)
        .itemInputs(`railways:slashed_locometal`, `#forge:plates/brass`)
        .circuit(1)
    ...
    event.recipes.gtceu.assembler(`tfg:railways/copper_wrapped_locometal`)
        .itemInputs(`railways:slashed_locometal`, `#forge:plates/copper`)
        .circuit(1)
    ...
    event.recipes.gtceu.assembler(`tfg:railways/iron_wrapped_locometal`)
        .itemInputs(`railways:slashed_locometal`, `#forge:plates/iron`)
        .circuit(1)
    ...
    event.recipes.gtceu.assembler(`tfg:railways/locometal_boiler`)
        .itemInputs(`railways:slashed_locometal`, `create:fluid_tank`)
        .circuit(1)
    ...
    global.MINECRAFT_DYE_NAMES.forEach(dye => {
        // Color Slashed Locometal
        event.recipes.gtceu.chemical_bath(`tfg:railways/slashed_locometal/color/${dye}`)             
            .itemInputs(`railways:slashed_locometal`)
            .inputFluids(Fluid.of(`gtceu:${dye}_dye`, 72))
            .itemOutputs(`railways:${dye}_slashed_locometal`)
            .duration(300)
            .EUt(4)
        // Decolor Slashed Locometal
        event.recipes.gtceu.chemical_bath(`tfg:railways/slashed_locometal/decolor/${dye}`)
            .itemInputs(`railways:${dye}_slashed_locometal`)
            .inputFluids(Fluid.of(`gtceu:chlorine`, 72))
            .itemOutputs(`railways:slashed_locometal`)
            .duration(300)
            .EUt(4)

        // Color Brass Wrapped Locometal
        event.recipes.gtceu.chemical_bath(`tfg:railways/brass_wrapped_locometal/color/${dye}`)             
            .itemInputs(`railways:brass_wrapped_locometal`)
            .inputFluids(Fluid.of(`gtceu:${dye}_dye`, 72))
            .itemOutputs(`railways:${dye}_brass_wrapped_locometal`)
            .duration(300)
            .EUt(4)
        // Decolor Brass Wrapped Locometal
        event.recipes.gtceu.chemical_bath(`tfg:railways/brass_wrapped_locometal/decolor/${dye}`)
            .itemInputs(`railways:${dye}_brass_wrapped_locometal`)
            .inputFluids(Fluid.of(`gtceu:chlorine`, 72))
            .itemOutputs(`railways:brass_wrapped_locometal`)
            .duration(300)
            .EUt(4)

        // Color Copper Wrapped Locometal
        event.recipes.gtceu.chemical_bath(`tfg:railways/copper_wrapped_locometal/color/${dye}`)             
            .itemInputs(`railways:copper_wrapped_locometal`)
            .inputFluids(Fluid.of(`gtceu:${dye}_dye`, 72))
            .itemOutputs(`railways:${dye}_copper_wrapped_locometal`)
            .duration(300)
            .EUt(4)
        // Decolor Copper Wrapped Locometal
        event.recipes.gtceu.chemical_bath(`tfg:railways/copper_wrapped_locometal/decolor/${dye}`)
            .itemInputs(`railways:${dye}_copper_wrapped_locometal`)
            .inputFluids(Fluid.of(`gtceu:chlorine`, 72))
            .itemOutputs(`railways:copper_wrapped_locometal`)
            .duration(300)
            .EUt(4)

        // Color Iron Wrapped Locometal
        event.recipes.gtceu.chemical_bath(`tfg:railways/iron_wrapped_locometal/color/${dye}`)             
            .itemInputs(`railways:iron_wrapped_locometal`)
            .inputFluids(Fluid.of(`gtceu:${dye}_dye`, 72))
            .itemOutputs(`railways:${dye}_iron_wrapped_locometal`)
            .duration(300)
            .EUt(4)
        // Decolor Iron Wrapped Locometal
        event.recipes.gtceu.chemical_bath(`tfg:railways/iron_wrapped_locometal/decolor/${dye}`)
            .itemInputs(`railways:${dye}_iron_wrapped_locometal`)
            .inputFluids(Fluid.of(`gtceu:chlorine`, 72))
            .itemOutputs(`railways:iron_wrapped_locometal`)
            .duration(300)
            .EUt(4)

        // Color Locometal Boiler
        event.recipes.gtceu.chemical_bath(`tfg:railways/locometal_boiler/color/${dye}`)             
            .itemInputs(`railways:locometal_boiler`)
            .inputFluids(Fluid.of(`gtceu:${dye}_dye`, 72))
            .itemOutputs(`railways:${dye}_locometal_boiler`)
            .duration(300)
            .EUt(4)
        // Decolor Locometal Boiler
        event.recipes.gtceu.chemical_bath(`tfg:railways/locometal_boiler/decolor/${dye}`)
            .itemInputs(`railways:${dye}_locometal_boiler`)
            .inputFluids(Fluid.of(`gtceu:chlorine`, 72))
            .itemOutputs(`railways:locometal_boiler`)
            .duration(300)
            .EUt(4)

        // Color Brass Wrapped Locometal Boiler
        event.recipes.gtceu.chemical_bath(`tfg:railways/brass_wrapped_locometal_boiler/color/${dye}`)             
            .itemInputs(`railways:brass_wrapped_locometal_boiler`)
            .inputFluids(Fluid.of(`gtceu:${dye}_dye`, 72))
            .itemOutputs(`railways:${dye}_brass_wrapped_locometal_boiler`)
            .duration(300)
            .EUt(4)
        // Decolor Brass Wrapped Locometal Boiler
        event.recipes.gtceu.chemical_bath(`tfg:railways/brass_wrapped_locometal_boiler/decolor/${dye}`)
            .itemInputs(`railways:${dye}_brass_wrapped_locometal_boiler`)
            .inputFluids(Fluid.of(`gtceu:chlorine`, 72))
            .itemOutputs(`railways:brass_wrapped_locometal_boiler`)
            .duration(300)
            .EUt(4)

        // Color Copper Wrapped Locometal Boiler
        event.recipes.gtceu.chemical_bath(`tfg:railways/copper_wrapped_locometal_boiler/color/${dye}`)             
            .itemInputs(`railways:copper_wrapped_locometal_boiler`)
            .inputFluids(Fluid.of(`gtceu:${dye}_dye`, 72))
            .itemOutputs(`railways:${dye}_copper_wrapped_locometal_boiler`)
            .duration(300)
            .EUt(4)
        // Decolor Copper Wrapped Locometal Boiler
        event.recipes.gtceu.chemical_bath(`tfg:railways/copper_wrapped_locometal_boiler/decolor/${dye}`)
            .itemInputs(`railways:${dye}_copper_wrapped_locometal_boiler`)
            .inputFluids(Fluid.of(`gtceu:chlorine`, 72))
            .itemOutputs(`railways:copper_wrapped_locometal_boiler`)
            .duration(300)
            .EUt(4)

        // Color Iron Wrapped Locometal Boiler
        event.recipes.gtceu.chemical_bath(`tfg:railways/iron_wrapped_locometal_boiler/color/${dye}`)             
            .itemInputs(`railways:iron_wrapped_locometal_boiler`)
            .inputFluids(Fluid.of(`gtceu:${dye}_dye`, 72))
            .itemOutputs(`railways:${dye}_iron_wrapped_locometal_boiler`)
            .duration(300)
            .EUt(4)
        // Decolor Iron Wrapped Locometal Boiler
        event.recipes.gtceu.chemical_bath(`tfg:railways/iron_wrapped_locometal_boiler/decolor/${dye}`)
            .itemInputs(`railways:${dye}_iron_wrapped_locometal_boiler`)
            .inputFluids(Fluid.of(`gtceu:chlorine`, 72))
            .itemOutputs(`railways:iron_wrapped_locometal_boiler`)
            .duration(300)
            .EUt(4)
