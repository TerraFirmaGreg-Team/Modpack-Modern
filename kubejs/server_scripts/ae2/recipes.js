...
const registerAE2Recipes = (event) => {
	...
	}).addMaterialInfo().id('tfg:crafting/certus_quartz_cutting_knife')
	...
	}).addMaterialInfo().id('tfg:crafting/nether_quartz_cutting_knife')
	...
	}).addMaterialInfo().id('tfg:crafting/network_tool')
	...
	// Void Card
	event.recipes.gtceu.shapeless('ae2:void_card', ['ae2:basic_card', 'ae2:calculation_processor'])
		.addMaterialInfo().id('tfg:crafting/void_card')

	// Equal Distribution Card
	event.recipes.gtceu.shapeless('ae2:equal_distribution_card', ['ae2:advanced_card', 'ae2:calculation_processor'])
		.addMaterialInfo().id('tfg:crafting/equal_distribution_card')

	// Energy Card
	event.recipes.gtceu.shapeless('ae2:energy_card', ['ae2:advanced_card', '2x gtceu:hv_lithium_battery'])
		.addMaterialInfo().id('tfg:crafting/energy_card')

	// Quartz Fixture
	event.recipes.gtceu.shapeless('ae2:quartz_fixture', [
		'ae2:charged_certus_quartz_crystal',
		'#forge:rods/aluminium'
	]).addMaterialInfo().id('tfg:crafting/quartz_fixture')

	// Light Detecting Fixture
	event.recipes.gtceu.shapeless('ae2:light_detector', [
		'#forge:gems/certus_quartz',
		'#forge:rods/wrought_iron'
	]).addMaterialInfo().id('tfg:crafting/light_detector')
