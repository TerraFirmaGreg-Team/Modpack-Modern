...
function registerTFGIconSets(event) {
    ...
    event.create('sheet').parent('rough')
...
function modifyTFGIconSets(event) {
    ...
    GTMaterials.Diatomite.setMaterialIconSet(GTMaterialIconSet.getByName('sheet'))
    ...
    GTMaterials.Lepidolite.setMaterialIconSet(GTMaterialIconSet.getByName('sheet'))
    GTMaterials.Lithium.setMaterialIconSet(GTMaterialIconSet.getByName('cubic_dull'))
    GTMaterials.Mica.setMaterialIconSet(GTMaterialIconSet.getByName('sheet'))
    ...
    GTMaterials.Neodymium.setMaterialIconSet(GTMaterialIconSet.getByName('sheet'))
    ...
    GTMaterials.Powellite.setMaterialIconSet(GTMaterialIconSet.getByName('sheet'))
    ...
    GTMaterials.Spodumene.setMaterialIconSet(GTMaterialIconSet.getByName('sheet'))
    ...
    GTMaterials.Tantalite.setMaterialIconSet(GTMaterialIconSet.getByName('sheet'))
    GTMaterials.Thorium.setMaterialIconSet(GTMaterialIconSet.getByName('cubic_metallic'))
    GTMaterials.TricalciumPhosphate.setMaterialIconSet(GTMaterialIconSet.getByName('sheet'))
    ...
    GTMaterials.Wulfenite.setMaterialIconSet(GTMaterialIconSet.getByName('sheet'))
