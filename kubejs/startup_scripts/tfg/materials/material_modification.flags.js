...
function registerTFGFlagsMaterialModification(event) {
	...
	GTMaterials.WroughtIron.addFlags(GENERATE_DOUBLE_INGOTS, GENERATE_SPRING_SMALL, HAS_TFC_TOOL, HAS_TFC_ARMOR, HAS_TFC_UTILITY);
	...
	GTMaterials.Invar.addFlags(GENERATE_RING, GENERATE_FOIL);
