...
const registerTFGCrops = (event) => {
	...
	const $AbstractCropBlockBuilder = Java.loadClass("io.github.notenoughmail.kubejstfc.builders.block.AbstractCropBlockBuilder")
	...
	event.create('tfg:sunflower_wild', 'tfc:wild_crop')
		.type($AbstractCropBlockBuilder.Type.DOUBLE)
		.soundType('crop')
	...
	event.create('tfg:lentil_wild', 'tfc:wild_crop')
		.type($AbstractCropBlockBuilder.Type.DEFAULT)
		.soundType('crop')
	...
	event.create('betterend:cave_pumpkin_wild', 'tfc:wild_crop')
		.type($AbstractCropBlockBuilder.Type.SPREADING)
		.soundType('crop')
