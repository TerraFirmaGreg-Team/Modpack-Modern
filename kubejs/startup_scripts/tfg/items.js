...
const registerTFGItems = (event) => {
    ...
    event.create('gtceu:black_steel_double_ingot').texture('tfg:item/deprecated').translationKey('item.tfg.deprecated')
    event.create('gtceu:red_steel_double_ingot').texture('tfg:item/deprecated').translationKey('item.tfg.deprecated')
    event.create('gtceu:blue_steel_double_ingot').texture('tfg:item/deprecated').translationKey('item.tfg.deprecated')

    event.create('gtceu:zinc_nugget').texture('tfg:item/deprecated').translationKey('item.tfg.deprecated')
    event.create('gtceu:brass_nugget').texture('tfg:item/deprecated').translationKey('item.tfg.deprecated')
    event.create('gtceu:copper_nugget').texture('tfg:item/deprecated').translationKey('item.tfg.deprecated')
    event.create('gtceu:vanadium_nugget').texture('tfg:item/deprecated').translationKey('item.tfg.deprecated')

    event.create('gtceu:copper_plate').texture('tfg:item/deprecated').translationKey('item.tfg.deprecated')
    event.create('gtceu:brass_plate').texture('tfg:item/deprecated').translationKey('item.tfg.deprecated')
    event.create('gtceu:gold_plate').texture('tfg:item/deprecated').translationKey('item.tfg.deprecated')
    event.create('gtceu:iron_plate').texture('tfg:item/deprecated').translationKey('item.tfg.deprecated')
    event.create('gtceu:cobalt_plate').texture('tfg:item/deprecated').translationKey('item.tfg.deprecated')
    event.create('gtceu:rose_gold_plate').texture('tfg:item/deprecated').translationKey('item.tfg.deprecated')
    event.create('gtceu:aluminium_plate').texture('tfg:item/deprecated').translationKey('item.tfg.deprecated')
    event.create('gtceu:invar_plate').texture('tfg:item/deprecated').translationKey('item.tfg.deprecated')
    event.create('gtceu:lead_plate').texture('tfg:item/deprecated').translationKey('item.tfg.deprecated')
    event.create('gtceu:nickel_plate').texture('tfg:item/deprecated').translationKey('item.tfg.deprecated')
    event.create('gtceu:osmium_plate').texture('tfg:item/deprecated').translationKey('item.tfg.deprecated')
    event.create('gtceu:palladium_plate').texture('tfg:item/deprecated').translationKey('item.tfg.deprecated')
    event.create('gtceu:platinum_plate').texture('tfg:item/deprecated').translationKey('item.tfg.deprecated')
    event.create('gtceu:rhodium_plate').texture('tfg:item/deprecated').translationKey('item.tfg.deprecated')
    event.create('gtceu:silver_plate').texture('tfg:item/deprecated').translationKey('item.tfg.deprecated')
    event.create('gtceu:vanadium_plate').texture('tfg:item/deprecated').translationKey('item.tfg.deprecated')
    event.create('gtceu:zinc_plate').texture('tfg:item/deprecated').translationKey('item.tfg.deprecated')

    event.create('gtceu:vanadium_block').texture('tfg:item/deprecated').translationKey('item.tfg.deprecated')
    event.create('gtceu:zinc_block').texture('tfg:item/deprecated').translationKey('item.tfg.deprecated')
    event.create('gtceu:brass_block').texture('tfg:item/deprecated').translationKey('item.tfg.deprecated')

    event.create('gtceu:gold_purified_ore').texture('tfg:item/deprecated').translationKey('item.tfg.deprecated')
    event.create('gtceu:copper_purified_ore').texture('tfg:item/deprecated').translationKey('item.tfg.deprecated')
    event.create('gtceu:zinc_purified_ore').texture('tfg:item/deprecated').translationKey('item.tfg.deprecated')
    event.create('gtceu:silver_purified_ore').texture('tfg:item/deprecated').translationKey('item.tfg.deprecated')
    event.create('gtceu:tin_purified_ore').texture('tfg:item/deprecated').translationKey('item.tfg.deprecated')
    event.create('gtceu:lead_purified_ore').texture('tfg:item/deprecated').translationKey('item.tfg.deprecated')
