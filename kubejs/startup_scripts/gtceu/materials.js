...
const modifyGTCEuMaterials = (event) => {
	
	//const $AdAstraItems = Java.loadClass('earth.terrarium.adastra.common.registry.ModItems')

	//TagPrefix.ingot.setIgnored(GTMaterialRegistry.getMaterial('desh'), $AdAstraItems.DESH_INGOT)
	//TagPrefix.nugget.setIgnored(GTMaterialRegistry.getMaterial('desh'), $AdAstraItems.DESH_NUGGET)
	//TagPrefix.plate.setIgnored(GTMaterialRegistry.getMaterial('desh'), $AdAstraItems.DESH_PLATE)
	//TagPrefix.block.setIgnored(GTMaterialRegistry.getMaterial('desh'), $AdAstraItems.DESH_BLOCK)
}