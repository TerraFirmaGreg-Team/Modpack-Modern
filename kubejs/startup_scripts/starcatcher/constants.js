...
if (Platform.isLoaded("starcatcher")){
    ...
    */
    ...
    global.STARCATCHER_FISH = /** @type {Object.<string, {dimension: string}>} */ ({
        ...
        'obidontiee': { dimension: ['minecraft:overworld'], biome: ['#starcatcher:is_ocean'], fluid: ['tfc:salt_water'], filet: 'common/white'},
        ...
        'silverfin_pike': { dimension: ['minecraft:overworld'], biome: [], filet: 'common/white' },
        'silverveil_perch': { dimension: ['minecraft:overworld'], biome: [], filet: 'common/white' },
        //'elderscale': { dimension: null, filet: 'white' },
        'driftfin': { dimension: ['minecraft:overworld'], biome: [], filet: 'common/white' },
        //'twilight_koi': { dimension: null, filet: 'white' },
        //'thunder_bass': { dimension: null, filet: 'white' },
        //'lightning_bass': { dimension: null, filet: 'white' },
        'sludge_catfish': { dimension: ['minecraft:overworld'], biome: [], filet: 'common/white' },
        'lily_snapper': { dimension: ['minecraft:overworld'], biome: [], filet: 'common/pink' },
        'sage_catfish': { dimension: ['minecraft:overworld'], biome: [], filet: 'common/white' },
        'pale_carp': { dimension: ['minecraft:overworld'], biome: [], filet: 'common/white' },
        'pale_pinfish': { dimension: ['minecraft:overworld'], biome: [], filet: 'common/white' },
        'pinfish': { dimension: ['minecraft:overworld'], biome: [], filet: 'common/pink' },
        //'frostjaw_trout': { dimension: null, filet: 'white' },
        //'crystalback_trout': { dimension: null, filet: 'white' },
        //'aurora': { dimension: null, filet: 'white' },
        'wintery_pike': { dimension: ['minecraft:overworld'], biome: [], filet: 'common/white' },
        'sandtail': { dimension: ['minecraft:overworld'], biome: [], filet: 'common/white' },
        'mirage_carp': { dimension: ['minecraft:overworld'], biome: [], filet: 'common/white' },
        'scorchfish': { dimension: ['minecraft:overworld'], biome: [], filet: 'common/pink' },
        'cactifish': { dimension: ['minecraft:overworld'], biome: [], filet: 'common/white' },
        'agave_bream': { dimension: ['minecraft:overworld'], biome: [], filet: 'common/pink' },
        'sunny_sturgeon': { dimension: ['minecraft:overworld'], biome: [], filet: 'common/pink' },
        'rockgill': { dimension: ['minecraft:overworld'], biome: [], filet: 'common/dark' },
        'peakdweller': { dimension: ['minecraft:overworld'], biome: [], filet: 'common/dark' },
        'sun_seeking_carp': { dimension: ['minecraft:overworld'], biome: [], filet: 'common/pink' },
        ...
        'drifting_bream': { dimension: ['minecraft:overworld'], biome: [], filet: 'common/white' },
        'downfall_bream': { dimension: ['minecraft:overworld'], biome: [], filet: 'common/white' },
        //'hollowbelly_darter': { dimension: null, filet: 'white' },
        'mistback_chub': { dimension: ['minecraft:overworld'], biome: [], filet: 'common/white' },
        ...
        'joel': { dimension: ['minecraft:overworld'], biome: [], filet: 'common/king' },
        'redscaled_tuna': { dimension: ['minecraft:overworld'], biome: [], filet: 'common/pink' },
        'bigeye_tuna': { dimension: ['minecraft:overworld'], biome: [], filet: 'common/king' },
        'sea_bass': { dimension: ['minecraft:overworld'], biome: [], filet: 'common/white' },
        ...
        'black_eel': { dimension: ['minecraft:overworld'], biome: [], filet: 'common/dark' },
