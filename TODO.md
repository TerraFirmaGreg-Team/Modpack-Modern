...
- Make that one other copper mineral (I think it spawns in one of the deep veins) melt into tfc copper? gtceu/materials.js
...
- A cold water "potion" that lowers your internal temp? Will need java code
